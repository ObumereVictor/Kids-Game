  ...
  return (
    <main className="homepage-bg">
      <div className="homepage">
        <p>
          Welcome to ALTCODE Spelling Game, an incredible app designed to make
          the journey of learning English spelling an enjoyable experience. With
          a vast collection of over 1000 commonly used words, this app caters to
